...
import kLatLng from './K_latlng.json'
...
var [myPolygon, setMyPolygon] = useState();
...
// }
   ...
   useEffect(() => {
    ...
    mapOption = { 
        ...
        // center: new kakao.maps.LatLng(1830624.984658704,991187.3083363455), // 지도의 중심좌표
        level: 8 // 지도의 확대 레벨
    };
